...
class TestCity_instantiation(unittest.TestCase):
    """Unittests for City class instanciation"""
...
class TestCity_to_dict(unittest.TestCase):
    ...
    def test_contains_correct_keys(self):
        """test to dict contain correct value"""
        my_city = City()
    ...
    def test_contains_added_attr(self):
        """test to dict contains added attr"""
        my_city = City()
    ...
    def test_datetime_attr_are_strs(self):
        """test to dict datetime atrr"""
        my_city = City()
