...
class TestHBNBCommand_show(unittest.TestCase):
   ...
   def test_invalid_class(self):
    ...
    def test_no_instance_found_dot_notation(self):
        """test show nos instance found dot"""
    ...
    def test_objects_space_notation(self):
        """test show obj space """
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
...
class TestHBNBCommand_update(unittest.TestCase):
    ...
    def test_invalid_id_space_notation(self):
        """test update invalid id space"""
        correct = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_invalid_id_dot_notation(self):
        """test update invalid dot"""
        correct = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_missing_attr_name_space_notation(self):
        """test update missing attr name space"""
    ...
    def test_missing_attr_value_space_notation(self):
        """test update missing attr value space"""
    ...
    def test_missing_attr_name_dot_notation(self):
        """test update missing attr name dot"""
        correct = "** attribute name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testId = output.getvalue().strip()
    ...
    def test_valid_string_attr_space_notation(self):
        """test update str attr space"""
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testId = output.getvalue().strip()
    ...
    def test_valid_string_attr_dot_notation(self):
        """test str attr dot"""
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
    ...
    def test_valid_int_attr_space_notation(self):
        """test update int attr space"""
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
    ...
    def test_valid_int_attr_dot_notation(self):
        """test valid int attr dot"""
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            tId = output.getvalue().strip()
    ...
    def test_valid_float_attr_dot_notation(self):
        """test update valid float attr dot"""
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            tId = output.getvalue().strip()
    ...
    def test_valid_float_attr_space_notation(self):
        """test update valid float atrr space"""
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
    ...
    def test_valid_dictionary_space_notation(self):
        """test update valid dict space"""
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testId = output.getvalue().strip()
        testCmd = "update BaseModel {} ".format(testId)
    ...
    def test_valid_dictionary_dot_notation(self):
        """test update valid dict dot"""
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testId = output.getvalue().strip()
        testCmd = "BaseModel.update({}".format(testId)
    ...
    def test_valid_dictionary_with_int_dot_notation(self):
        """test update valid dict with int dot"""
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "Place.update({}, ".format(testId)
    ...
    def test_valid_dictionary_with_int_space_notation(self):
        """test update valid dict with int space"""
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "update Place {} ".format(testId)
    ...
    def test_valid_dictionary_with_float_space_notation(self):
        """test update valid dict with float space"""
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "update Place {} ".format(testId)
...
class TestHBNBCommand_destroy(unittest.TestCase):
    ...
    def test_id_missing_space_notation(self):
        """test destroy id missing space"""
        correct = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_objects_dot_notation(self):
        """test destroy obj dot"""
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testID = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_all(unittest.TestCase):
    ...
    def test_single_object_space_notation(self):
        """test all single obj space"""
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertFalse(HBNBCommand().onecmd("create State"))
    ...
    def test_single_object_dot_notation(self):
        """test all single obj dot"""
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertFalse(HBNBCommand().onecmd("create State"))
